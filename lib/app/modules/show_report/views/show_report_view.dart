    ...
    return GetBuilder<ShowReportController>(
      builder: (controller) {
        return CommonScreen(
          ...
          body: Get.arguments == AppString.monthlyPurchase ||
                                ...
                                children: [
                                  ...
                                  TableRow(
                                    children: [
                                      ...
                                      commonTableText(
                                          title: model.grossAmount.toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                  TableRow(
                                  ...
                                  TableRow(
                                    children: [
                                      ...
                                      commonTableText(
                                          title: model.creditDays.toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                  TableRow(
                                  ...
                                  TableRow(
                                    children: [
                                      ...
                                      commonTableText(
                                          title:
                                              model.totalOutstanding.toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                  TableRow(
                                  ...
                                  TableRow(
                                    children: [
                                      commonTableText(
                                          title: "Sale Amount Ex. Discount"),
                                      commonTableText(
                                          title: model.saleAmountExDiscount
                                              .toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                  ...
                                  TableRow(
                                    children: [
                                      commonTableText(
                                          title: "Sale Amount inc. Discount"),
                                      commonTableText(
                                          title: model.saleAmountIncDiscount
                                              .toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                  ...
                                  TableRow(
                                    children: [
                                      ...
                                      commonTableText(
                                          title: model.gstinNumber.toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                  TableRow(
                                    children: [
                                      commonTableText(
                                          title: "Customer GST Type"),
                                      commonTableText(
                                          title:
                                              model.customerGSTType.toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                  TableRow(
                                    children: [
                                      commonTableText(
                                          title: "Sale Taxable AMT"),
                                      commonTableText(
                                          title:
                                              model.saleTaxableAmt.toString(),
                                          isEnd: true),
                                    ],
                                  ),
                                ],
                    ...
                    children: [
                      TableRow(
                        children: [
                          ...
                          commonTableText(title: model.partyname, isEnd: true),
                        ],
                      ),
                      TableRow(
                        children: [
                      ...
                      TableRow(
                        children: [
                          ...
                          commonTableText(
                              title: model.totalOutstanding.toString(),
                              isEnd: true),
                        ],
                      ),
                      TableRow(
