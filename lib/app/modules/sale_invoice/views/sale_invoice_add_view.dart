                    ...
                    (index) {
                      return GestureDetector(
                        onTap: () {
                          ...
                          controller.salesPersonId =
                              controller.salesList[index].salesPersonId!;
                          controller.collapse();
                          controller.update();
                        },
                        child: Padding(
                      ...
                      CommonButton(
                        ...
                        onTap: () {
                          controller.itemList.add(SaleDetails(
                            ...
                            cgstPer: controller.addGstTypeController.text ==
                                    "CGST_SGST"
                                ? double.parse(
                                    controller.itemCGstPerController.text)
                                : 0.0,
                            cgstAmount: controller.addGstTypeController.text ==
                                    "CGST_SGST"
                                ? double.parse(
                                    controller.itemCGstAmtController.text)
                                : 0.0,
                            sgstPer: controller.addGstTypeController.text ==
                                    "CGST_SGST"
                                ? double.parse(
                                    controller.itemSGstPerController.text)
                                : 0.0,
                            sgstAmount: controller.addGstTypeController.text ==
                                    "CGST_SGST"
                                ? double.parse(
