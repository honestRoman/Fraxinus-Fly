...
import 'package:fraxinusfly/app/modules/sale_invoice/controllers/sale_invoice_controller.dart';
...
class SaleInvoiceAddView extends GetView<SaleInvoiceController> {
  ...
  Widget itemData(SaleInvoiceController controller) {
    // Define column list
  ...
  void filterItems(String query) {
    if (query.isEmpty) {
      filteredItems = Constants.itemList; // Reset to full list when query is empty
    } else {
      filteredItems = Constants.itemList
          .where((item) =>
                      ...
                      CommonButton(
                        ...
                        onTap: () {
                          controller.itemList.add(SaleDetails(
                            ...
                            cgstPer: controller.addGstTypeController.text == "CGST_SGST" ? double.parse(controller.itemCGstPerController.text) : 0.0,
                            cgstAmount: controller.addGstTypeController.text == "CGST_SGST" ? double.parse(controller.itemCGstAmtController.text) : 0.0,
                            sgstPer: controller.addGstTypeController.text == "CGST_SGST" ? double.parse(controller.itemSGstPerController.text) : 0.0,
                            sgstAmount: controller.addGstTypeController.text == "CGST_SGST" ? double.parse(controller.itemSGstAmtController.text) : 0.0,
                            igstPer: controller.addGstTypeController.text == "IGST" ? double.parse(controller.itemIGstPerController.text) : 0.0,
                            igstAmount: controller.addGstTypeController.text == "IGST" ? double.parse(controller.itemIGstAmtController.text) : 0.0,
